...
const HalalService = () => {
  return (
    <div className='mt-[60px] lg:mt-[120px] font-sans'>
      <h2 className='text-[#005447] text-wrap justify-normal lg:text-[32px] font-bold'>Here’s What We Do</h2>
      <div className='flex flex-col lg:flex-row lg:justify-between gap-6 lg:gap-[116px]'>
        ...
        <div className='order-2 lg:order-1 md:text-justify shrink-0 lg:w-[528px]'>
          ...
          <p className='pt-4 lg:pt-3 text-sm lg:text-base  lg:font-normal text-[#646464]'>
