...
const ContactUs = () => {
  ...
  return (
    <div className='mt-[60px] lg:mt-[120px]  lg:space-y-0 font-montserrat'>
      ...
      <div className="flex flex-col space-y-1">
        <label htmlFor="email" className="text-[#646464] font-medium text-sm lg:font-semibold lg:text-base">
          Your Email
        </label>
        <input
          type="text"
      ...
      <div className="flex flex-col space-y-1">
        <label htmlFor="contactNumber" className="text-[#646464] font-medium text-sm lg:font-semibold lg:text-base">
          Contact Number
        </label>
        <input
          type="text"
      ...
      <div className="flex flex-col space-y-1">
        <label htmlFor="message" className="text-[#646464] font-medium text-sm lg:font-semibold lg:text-base">
          Leave a Message
        </label>
        <input
          type="text"
      ...
      <div className="flex flex-col space-y-1">
        <label htmlFor="enquiryFor" className="text-[#646464] font-medium text-sm lg:font-semibold lg:text-base">
          Enquiry For
        </label>
