...
const Herosection = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center  justify-between lg:gap-40 ">
      {/* Text section */}
      <div className="order-2 lg:order-1 flex flex-col items-start lg:w-[517px] flex-grow">
        ...
        <p className="text-[#313131] pt-4 font-normal text-base leading-6 font-montserrat text-justify lg:!text-left">
