    ...
    <div className="mt-[60px] lg:mt-[120px] font-montserrat">
      <div className="flex flex-col lg:flex-row lg:justify-between gap-6 lg:gap-[116px]">
        <div className="order-2 lg:order-1 leading-6  shrink-0 lg:w-[528px]">
          <p className=" text-sm lg:text-base font-normal text-[#646464] text-justify lg:!text-left">
          ...
          <p className="pt-4 lg:pt-3 text-sm lg:text-base text-justify lg:!text-left leading-6 lg:font-normal text-[#646464]">
