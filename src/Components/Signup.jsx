...
const Singup = () => {
  return (
    <div className='items-center flex justify-center py-6 lg:pt-[163px] lg:pb-[154px]'>
    ...
    <label className='text-sm font-semibold text-[#646464] font-sans'>Enter your Full Name</label>
    <input
      type='text'
  ...
  <div className='space-y-1 flex flex-col'>
    ...
    <p className='flex pt-4 justify-end'><span className='font-normal text-black text-base font-sans'>Already Register? </span><Link to='/Login' className='text-[#008F78] font-semibold text-base font-sans underline pl-1 '>Login</Link></p>
    </div>
    </div>
  )
}
